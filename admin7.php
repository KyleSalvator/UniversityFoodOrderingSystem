...
$total_orders = 0; // Initialize total orders variable
...
// Display total income and total orders
echo "<tr><td colspan='6'>Total Income: $total_income</td></tr>";
echo "<tr><td colspan='6'>Total Orders: $total_orders</td></tr>";
